...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Eduardo Milbrath",
          from_email: form.email,
          to_email: "milbratheduardo@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Muito Obrigado. Entrarei em contato assim que possível.");
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>Mande-me uma mensagem</p>
